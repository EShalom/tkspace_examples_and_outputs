...
for c in case:
    ...
    for noise in snr[1:]:
        for i in range(1,6):
            fname = '1d1c_case{}_guess{}_{}snr_r{}_0.0001step_{}Dt_{}maxiter'.format(c,guess[0],noise,i,Dt[0],maxiter)
            pylist += [fname+'.py']
            flist += [fname+'.txt']
...
for time in Dt[1:]:
        fname = '1d1c_case{}_guess{}_{}snr_0.0001step_{}Dt_{}maxiter'.format(c,guess[0],snr[0],time,maxiter)
        pylist += [fname+'.py']
        flist += [fname+'.txt']
