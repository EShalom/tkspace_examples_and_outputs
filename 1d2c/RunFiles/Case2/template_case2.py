...
from tkspace.forward_models.onedim.cases import case_1D2C_cm as gen_case
...
updatemethod= 'adam'
step        = 0.00005
fdir        = 'PH5'#{}_flow_{}d{}c_guess{}_case{}_step{}_SNR{}_Dt{}_{}opt_maxiter{}'.format(strftime("%Y%m%d"),dims, comp, guess_no, case, step,SNR,Dt,updatemethod,maxiter)  #21112021_gtinterp/adams_2ogeval_step00005_tres_T80_1000iter_{}d{}c_pic{}_case{}_SNR{}_Dt{}_g{}_dx1'.format(dims,comp,pic,case,SNR,Dt,guess_no)
mkdir(fdir)
#%%
...
max_vals = [1.4,0.15,4e-6,1,1,15] #(f, F, D, v, va_frac, J)
