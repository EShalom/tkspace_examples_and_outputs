...
for c in cases:
    for g in guess:
        fname = 'case{}_guess{}_0snr_0.00005step_1Dt_10000maxiter'.format(c,g)
        pylist += [fname+'.py']
        flist += [fname+'.txt']
    ...
    for g in guess:
        fname = 'case{}_guess{}_0snr_0.00005step_2Dt_10000maxiter'.format(c,g)
        pylist += [fname+'.py']
        flist += [fname+'.txt']
    ...
    for noise in snr[1:]:
        for i in range(1,6):
            fname = 'case{}_guess1_r{}_{}snr_0.00005step_1Dt_10000maxiter'.format(c,i,noise)
            pylist += [fname+'.py']
            flist += [fname+'.txt']
    ...
    for noise in snr[1:]:
        for i in range(1,6):
            fname = 'case{}_guess1_r{}_{}snr_0.00005step_2Dt_10000maxiter'.format(c,i,noise)
            pylist += [fname+'.py']
            flist += [fname+'.txt']
    ...
    for samp in Dt:
        fname = 'case{}_guess1_0snr_0.00005step_{}Dt_10000maxiter'.format(c,samp)
        pylist += [fname+'.py']
        flist += [fname+'.txt']
